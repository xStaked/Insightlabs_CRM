...
export default function AutomationsPage() {
  ...
  return (
    <div className="page-stack">
      <PageHeader
        title="Automations and scoring"
        description="Phase 5 is now operational: build rules, review execution history, inspect lead score events and expose automatic tag surface."
        actions={
          <div className="action-row">
            <Button variant={editingAutomation ? "secondary" : "primary"} onClick={() => setEditingAutomation(null)}>
              {editingAutomation ? "Create new automation" : "Ready for new rule"}
            </Button>
          </div>
        }
      />
      ...
      <div className="stats-grid">
        <StatCard label="Rules" value={String(automationList.length)} hint="Configured automations for the active tenant." />
        <StatCard label="Active" value={String(activeAutomations)} hint="Rules currently eligible for execution." />
        <StatCard label="Scoring" value={String(scoringActions)} hint="Automations that add points to leads." />
      </div>
      ...
      <div className="two-column-grid">
        ...
        <Card title="Automation registry" subtitle="Create, pause and reopen rules without leaving the console.">
          {automationList.length > 0 ? (
                ...
                <article className="timeline-item automation-item" key={automation.id}>
                  <div className="topbar-row">
                    <div className="inline-stack">
                      ...
                      <span className="muted-text">{automation.trigger_type}</span>
                    </div>
            ...
            <div className="muted-text">No automations yet. Use the builder to create the first rule.</div>
          )}
        </Card>
      </div>
      ...
      <div className="two-column-grid">
        ...
        <div className="inline-stack">
          <Card title="Lead selector" subtitle="Choose a lead to inspect score events and automatic tags.">
            <Field label="Lead">
          ...
          {scoreEvents.isLoading || leadTags.isLoading ? (
            <div className="muted-text">Loading lead scoring context...</div>
